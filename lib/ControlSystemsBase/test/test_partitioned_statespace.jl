...
# 4 | 5 6
# 7 | 8 9
sys1 = ControlSystemsBase.PartitionedStateSpace(ss(1.0, [2.0 3.0], [4.0; 7.0], [5.0 6.0; 8.0 9.0]), 1, 1)
...
##
sys2 = ControlSystemsBase.PartitionedStateSpace(ss(fill(1.0, 2, 2), fill(2.0, 2, 5), fill(3.0, 7, 2), fill(4.0, 7, 5)), 2, 3)
...
@test propertynames(sys1) == (:P, :nu1, :ny1, :A, :B, :C, :D, :B1, :B2, :C1, :C2, :D11, :D12, :D21, :D22, :nu, :ny, :nx)
