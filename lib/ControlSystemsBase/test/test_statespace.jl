...
@testset "test_statespace" begin
    ...
    for SS in (StateSpace, HeteroStateSpace), SS2 in (StateSpace, HeteroStateSpace)
        ...
        # Construct with C=I
        @test SS([-5 0; 0 -5],[2; 2],I,0).C == I(2)
        @test SS([-5 0; 0 -5],[2; 2],I,randn(2,1)).C == I(2)

        @test SS([-5 0; 0 -5],[2; 2],I,0, 1.0).C == I(2)
        @test SS([-5 0; 0 -5],[2; 2],I,randn(2,1), 1.0).C == I(2)
        ...
        @test_throws DimensionMismatch C_111_d.*M # We do not allow broadcasting with non-diagonal matrices https://github.com/JuliaControl/ControlSystemsBase.jl/issues/416
