...
@test C_111 / 2 == 0.5*C_111
@test (C_111 / C_111) == zpk(1)
...
@test typeof(zpk(tf([1], [2], 0.1))) == TransferFunction{Discrete{Float64},ControlSystemsBase.SisoZpk{Float64,Complex{Float64}}}
@test typeof(zpk([-0.5], [], 1)) == TransferFunction{Continuous,ControlSystemsBase.SisoZpk{Float64,Float64}}
end
