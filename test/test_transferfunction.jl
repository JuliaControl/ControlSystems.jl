...
@test_throws ErrorException TransferFunction(C_111.matrix, 0.01, 2, 1) # Explicit dimension mismatch
@test_throws ErrorException TransferFunction(C_111.matrix, 0.01, 1, 2) # Explicit dimension mismatch
