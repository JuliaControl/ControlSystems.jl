...
numbertype{T}(::Type{<:SisoZpk{T}}) = T
numbertype{T}(::Type{SisoRational{T}}) = T
...
Base.promote_rule(::Type{TransferFunction{<:SisoTf{T1}}}, ::Type{StateSpace{T2}}) where {T1,T2} = StateSpace{promote_type(T1, T2)}
...
#Base.promote_rule(::Type{SisoZpk}, ::Type{SisoTf}) = SisoTf # NOTE:??
